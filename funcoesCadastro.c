...
void alteraCadastro(void)
{
    ...
    char *opcoesAlteracao[] = {"Alterar Situacao da mensalidade",
                               "Alterar Situacao aluno",
                               "Salvar alteracoes",
                               "Cancelar Mudancas"};
